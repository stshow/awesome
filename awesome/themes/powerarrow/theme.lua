...
theme.wallpaper                                 = "/home/steve/Pictures/high_tech_earth-wallpaper-1920x1080.jpg"
theme.font                                      = "Iosevka Term Regular 9"
...
-- Textclock
local textclock = wibox.widget.textclock("<span font='Tamzen 5'> </span>%H:%M ")
textclock.font = theme.font

-- Calendar
theme.cal = lain.widget.calendar({
    --cal = "cal --color=always",
    attach_to = { textclock.widget },
    notification_preset = {
